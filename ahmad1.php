...
<html lang="en">
<head>
  <title>Profil : Ahmad / 145410128</title>
  <meta charset="utf-8">
...
<div class="container"> 
	<div class="row">
		<div class="col">
		<h2>Profil Ahmad Qomaruddin</h2>
		<table class="table" border="0" >
		<tr>
			<td align=left>Nama</td>
			<td>:</td>
			<td align=left>Ahmad Qomaruddin</td>
			<td rowspan='6'> <img src="pict/fta.jpg"> </td>
		<tr>
		<tr>
			<td align=left>NIM</td>
			<td>:</td>
			<td align=left>145410128</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td align=left>Krapyak Wetan, Panggungharjo, Sewon, Bantul, Yogyakarta</td>
		</tr>
		</table>
		</div>
	</div>
