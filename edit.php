...
if(isset($_SESSION['user'])){
	...
	if (isset($_POST['submit'])){
		...
		include "koneksi.php";
		$query=("update tabel_soal set pertanyaan='$pertanyaan',pilihan_a='$pilihan_a',pilihan_b='$pilihan_b',
		pilihan_c='$pilihan_c',pilihan_d='$pilihan_d',jawaban='$jawaban',publish='$publish' where id_soal='$id'");
	...
	$id=$_GET['id'];
	include "koneksi.php";
	$query=("select * from tabel_soal where id_soal='$id'");
	$hasil = mysqli_query($kon, $query);
		if(!$hasil){
